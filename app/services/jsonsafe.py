...
def make_json_safe(obj):
    ...
    if isinstance(obj, (pd.Series, pd.Index)): return make_json_safe(obj.to_list())
    if isinstance(obj, pd.DataFrame): return [make_json_safe(r) for r in obj.to_dict(orient="records")]
